...
public class SalesManagerServiceController {
    ...
    public ResponseEntity<List<User>> getAllManagers(){
        List<User> managers = userService.getListOfAllSalesManagers();
        if(managers != null){
    ...
    @PostMapping()
    public ResponseEntity createManager(@RequestBody User_DTO userDTO){
        try{
